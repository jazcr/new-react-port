const projectData = [
    {
        ...
        info: 'A simple blog site that allows extraterrestrial believers to create posts and drop pins where they hvae seen suspicious activity. Created in a team setting.',
